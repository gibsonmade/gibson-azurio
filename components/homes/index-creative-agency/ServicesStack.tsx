...
const MARQUEE_WORDS = siteCopy.home.servicesMarquee;
...
const SERVICE_IMAGES = [
  "/img-temp/services/services-stack/pr01.webp",
  "/img-temp/services/services-stack/pr02.webp",
  "/img-temp/services/services-stack/pr03.webp",
  "/img-temp/services/services-stack/pr04.webp",
] as const;

const CREATIVE_SERVICE_CARDS: CreativeServiceCard[] = siteCopy.home.services.map(
  (service, index) => ({
    ...service,
    imageSrc: SERVICE_IMAGES[index],
    imageWidth: 1920,
    imageHeight: 1180,
    coverClassName: index === 3 ? "cover-darken" : undefined,
  })
);
